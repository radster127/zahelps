...
$moduleSingularName = $manager->name;
$modulePluralName = $moduleSingularName . 's';
...
$list_url = url('admin/' . $module . "/directors");
...
$qs = "manager_id=" . $manager->id . "&from_date=" . $from_date . "&to_date=" . $to_date . "&record_per_page=" . $record_per_page;
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group btn-group-solid">
                            ...
                            <a onclick="return confirm('Are you sure to remove this user from {{ $moduleSingularName }}?')" title="Remove From {{ $moduleSingularName }}" href="{{ route('remove-director', ['user_id' => $row->id, 'manager_id' => $row->manager_id]) }}" class="btn btn-danger btn-sm"><i class="fa fa-close"></i></a>
