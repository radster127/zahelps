...
$pageTitle = "Manage Pending " . $modulePluralName;
...
$rows->setPath(url('admin/gh/pending'));
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group btn-group-solid">
                            ...
                            <a title="Make Manual Pair" href="{{ url('admin/gh/pending/' . $row->id) }}" class="btn btn-info btn-sm"><i class="fa fa-briefcase"></i></a>
                            @endif
