...
$moduleSingularName = 'Faq';
$modulePluralName = 'Faq';
...
<div class="box box-block bg-white">
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-striped">
            <thead>
                <tr>
                    <th class="col-md-10">{!! \App\Custom::getSortingLink($list_url, 'Title', 'faq.title', $sortBy, $sortOrd, $searchBy, $searchByVal, $qs) !!}</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="col-md-10">{{ $row->title }}</td>
                    <td class="col-md-2">
