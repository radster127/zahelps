            ...
            <div class="panel panel-info">
                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        ...
                        @if ($gh_settings['feature'] == 0)
                        <h4 class="text-danger text-center">Sorry, GH Request Was Closed. Please wait to activated.</h4>
                        <?php /* @elseif ($last_30_days_gh_req_count >= 5)
                          <h4 class="text-danger text-center">Sorry, You can not get help more. You already provide help 5 times in last 30 days.</h4> */ ?>
                        @else
                        {!! Form::open(['url' => url('member/get-help'), 'class' => 'module_form']) !!}
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-12">
                        ...
                        <div class="form-actions text-right">
                            <button type="submit" class="btn btn-lg btn-success">Get Help Request</button>
                        </div>
                        {!! Form::close() !!}
